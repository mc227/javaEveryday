...
//    Search the file for information related to the specified id.
//    Display it in the format used in the file.
//    The program is started with one argument: id (an int). Close the streams. The file data is separated by spaces and stored in the following order: id productName
