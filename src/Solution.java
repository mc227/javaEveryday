...
//public class Solution {
//    /*
//    * I remember that there was this thing about getlist, print list
//    * and then a special thread list
//    * I'm trying to write it up without looking
//    * */
//
//    // I remember a class that extends threads with super in the constructor
...
//        @Override
//        public void run() {
//            // print list and get list goes here
//            printList(getList(20), getName());
//        }
//    }
//
//    public static List<String> getList(int n) {
//        // i give it an n and I have this arraylist of stuff
//        List<String> list = new ArrayList<>(n);
//        for(int i = 0; i < n; i++) {
//            list.add(String.format("String %s", i+1));
//        }
//        return list;
//    }
//
//    public static void printList(List<String> list, String foo) {
//        for(String item:list) {
//            System.out.println(String.format("%s: %s", foo, item));
//        }
//    }
//
//    public static void main(String[] args) throws InterruptedException {
//        SpecialThread thread1 = new SpecialThread("thread1");
//        SpecialThread thread2 = new SpecialThread("thread2");
//        thread1.start();
//        thread1.join();
//        thread2.start();
//
...
//////        @Override
//////        public void run() {
//////            System.out.println("My name is, what?");
...
//////
//////    public static void main(String[] args) throws InterruptedException {
//////        Thread myPrinter = new Thread(new Printer("Slim shady"));
//////        myPrinter.start();
//////        myPrinter.join();
//////    }
//////}
...
////////            System.out.println(this.owner + " has stopped playing.");
////////            return new Date();
////////        }
////////
////////        @Override
...
////////            System.out.println("Played for " + String.valueOf(end.getTime() - start.getTime()) + " (ms)");
////////        }
////////    }
////////
////////    public static void main(String[] args) {
////////        Thread thread = new Thread(new Violin("Mark Costales"));
////////        thread.start();
////////    }
////////}
////////
...
//////////
//////////    Requirements:
//////////    •	Add a public static class called SpecialThread to the Solution class.
//////////    •	The SpecialThread class should not inherit any additional class.
//////////    •	The SpecialThread class must implement the Runnable interface.
//////////    •	The SpecialThread class's run method should display its own stack trace.
//////////    * */
...
//////////////Requirements:
//////////////•	Add a public static class called TestThread to the Solution class.
//////////////•	The TestThread class must implement the Runnable interface.
//////////////•	The TestThread class's run method should display "My first thread".
//////////////•	The program should display "My first thread".
//////////////•	Don't change the main method.
//////////////    * */
...
////////////////}
////////////////
//////////////////// 1603 from scratch. without looking at the solution
//////////////////
//////////////////import java.util.*;
//////////////////
//////////////////public class Solution {
//////////////////    // create a runnable class that will be able to pass on a thread
//////////////////    // create a volatile arraylist of thread that I will loop through later
//////////////////    public static volatile List<Thread> list = new ArrayList<>(5);
//////////////////
//////////////////    public static class SpecialThread implements Runnable {
//////////////////        @Override
...
//////////////////////    public static class TestThread extends Thread {
//////////////////////        static {
//////////////////////            System.out.println("This is the static block inside Test Thread");
//////////////////////        }
//////////////////////
//////////////////////        @Override
//////////////////////        public void run() {
...
////////////////////////        @Override
////////////////////////        public void run() {
////////////////////////            System.out.println("This is not really my first thread");
////////////////////////        }
////////////////////////    }
////////////////////////}
////////////////////////
