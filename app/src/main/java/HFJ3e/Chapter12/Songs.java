...
//        List<Song> foo = songs.stream().filter(song -> song.getGenre().contains("Rock")).collect(Collectors.toList());
//        System.out.println(foo);

//        List<Song> byTheBeatles = songs.stream().filter(song -> song.getArtist().contains("Beatles")).collect(Collectors.toList());
//        System.out.println(byTheBeatles);

//        List<Song> startsWithH =
//                songs.stream().filter(song -> song.getTitle().startsWith("H")).collect(Collectors.toList());
//        System.out.println(startsWithH);

//        List<Song> moreRecentThan1995 =
//                songs.stream().filter(song -> song.getYear() > 1995).collect(Collectors.toList());
//        System.out.println(moreRecentThan1995);
