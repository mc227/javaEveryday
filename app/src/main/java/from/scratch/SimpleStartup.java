...
public class SimpleStartup {
    /**
     ...
     DECLARE checkYourself method that compares the user's guess to each item of the locationCells.
     DECLARE setLocationCells that sets an int array and assigns it to the locationCells
     ...
     METHOD voidSetLocation(int[] loc)
